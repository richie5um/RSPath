...
var pathSet = function (obj, path, value, separator) {
  ...
  var pathElements = _.isArray(path) ? path : path.split(separator);
...
var pathDelete = function (obj, path, separator) {
  // Basic input validation
  if (undefined === obj || undefined === path || 0 === path.length) {
    return false;
  }
...
var pathGet = function (obj, path, separator) {
  // Basic input validation
  if (undefined === obj || undefined === path || 0 === path.length) {
    return undefined;
  }
